...
const uint8_t ghost2[] = {0x18,0x7e,0xbd,0xff,0xff,0xff,0xff,0xa5};
const uint8_t ghost3[] = {0x18,0x7e,0xdb,0xff,0xff,0xff,0xff,0xa5};
const uint8_t ghost4[] = {0x18,0x7e,0xff,0xdb,0xff,0xff,0xff,0xa5};
const uint8_t ghost5[] = {0x18,0x7e,0x99,0x99,0xff,0xff,0xff,0xa5};
const uint8_t ghost6[] = {0x3c,0x7e,0xd7,0xff,0xc3,0xff,0xff,0xdb};
