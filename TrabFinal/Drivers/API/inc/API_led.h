...
/* FSM Display LED States */
static uint8_t smileyFace[] = { 0x3C, 0x42, 0x95, 0xA1, 0xA1, 0x95, 0x42, 0x3C }; // Smiley face for GOOD state
static uint8_t A[] = { LED_OFF, 0x7c, 0x12, 0x12, 0x12, 0x12, 0x7c, LED_OFF }; // Letter A
static uint8_t B[] = { LED_OFF, 0x7E, 0x4A, 0x4A, 0x4A, 0x4A, 0x34, LED_OFF }; // Letter B
static uint8_t C[] = { LED_OFF, 0x3C, 0x42, 0x42, 0x42, 0x42, 0x24, LED_OFF }; // Letter C

/* @brief LED Bar Score Representations */
static uint8_t zero[] = { LED_OFF, LED_OFF, LED_OFF, LED_OFF, LED_OFF, LED_OFF,
		LED_OFF, LED_OFF }; // No rows lit
...
static uint8_t four[] = { LED_ON, LED_ON, LED_ON, LED_ON, LED_ON, LED_ON,
		LED_ON, LED_ON }; // All rows lit
static uint8_t heart[] = { 0x0C, 0x1E, 0x3E, 0x7C, 0x3E, 0x1E, 0x0C, LED_OFF }; // Heart shape pattern
