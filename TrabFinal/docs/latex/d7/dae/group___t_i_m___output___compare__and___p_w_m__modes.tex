...
Diagrama de colaboración para T\+IM Output Compare and P\+WM Modes\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d7/dae/group___t_i_m___output___compare__and___p_w_m__modes}
\end{center}
\end{figure}
