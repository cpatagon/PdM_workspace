...
Diagrama de colaboración para Extended Peripheral Control functions\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d3/dce/group___t_i_m_ex___exported___functions___group5}
\end{center}
\end{figure}
