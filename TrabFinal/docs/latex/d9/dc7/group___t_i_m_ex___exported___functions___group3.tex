...
Diagrama de colaboración para Extended Timer Complementary P\+WM functions\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d9/dc7/group___t_i_m_ex___exported___functions___group3}
\end{center}
\end{figure}
