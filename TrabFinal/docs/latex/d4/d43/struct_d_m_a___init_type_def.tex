\hypertarget{struct_d_m_a___init_type_def}{}\doxysection{Referencia de la Estructura D\+M\+A\+\_\+\+Init\+Type\+Def}
...
Specifies if the F\+I\+FO mode or Direct mode will be used for the specified stream. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___f_i_f_o__direct__mode}{D\+MA F\+I\+FO direct mode}} \begin{DoxyNote}{Nota}
...
Specifies the Burst transfer configuration for the memory transfers. It specifies the amount of data to be transferred in a single non interruptible transaction. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___memory__burst}{D\+MA Memory burst}} \begin{DoxyNote}{Nota}
...
Specifies the operation mode of the D\+M\+Ay Streamx. This parameter can be a value of \mbox{\hyperlink{group___d_m_a__mode}{D\+MA mode}} \begin{DoxyNote}{Nota}
...
Specifies the Burst transfer configuration for the peripheral transfers. It specifies the amount of data to be transferred in a single non interruptible transaction. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___peripheral__burst}{D\+MA Peripheral burst}} \begin{DoxyNote}{Nota}
The burst mode is possible only if the address Increment mode is enabled. 
\end{DoxyNote}
