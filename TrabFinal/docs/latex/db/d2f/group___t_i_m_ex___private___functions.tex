\hypertarget{group___t_i_m_ex___private___functions}{}\doxysection{T\+IM Extended Private Functions}
\label{group___t_i_m_ex___private___functions}\index{TIM Extended Private Functions@{TIM Extended Private Functions}}
Diagrama de colaboración para T\+IM Extended Private Functions\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=284pt]{db/d2f/group___t_i_m_ex___private___functions}
\end{center}
\end{figure}
