\hypertarget{stm32f4xx__hal__def_8h}{}\doxysection{Referencia del Archivo Drivers/\+S\+T\+M32\+F4xx\+\_\+\+H\+A\+L\+\_\+\+Driver/\+Inc/stm32f4xx\+\_\+hal\+\_\+def.h}
...
Dependencia gráfica adjunta para stm32f4xx\+\_\+hal\+\_\+def.\+h\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d8/df5/stm32f4xx__hal__def_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d5/d4e/stm32f4xx__hal__def_8h__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{                                \textcolor{keywordflow}{do}\{                                        \(\backslash\)}
\DoxyCodeLine{                                    if((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_ad4cf225029dbefe8d3fe660c33b8bb6b}{Lock}} == HAL\_LOCKED)   \(\backslash\)}
\DoxyCodeLine{                                    \{                                      \(\backslash\)}
\DoxyCodeLine{                                       return HAL\_BUSY;                    \(\backslash\)}
\DoxyCodeLine{                                    \}                                      \(\backslash\)}
\DoxyCodeLine{                                    else                                   \(\backslash\)}
\DoxyCodeLine{                                    \{                                      \(\backslash\)}
\DoxyCodeLine{                                       (\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_ad4cf225029dbefe8d3fe660c33b8bb6b}{Lock}} = HAL\_LOCKED;    \(\backslash\)}
\DoxyCodeLine{                                    \}                                      \(\backslash\)}
\DoxyCodeLine{                                  \}\textcolor{keywordflow}{while} (0U)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{                                  \textcolor{keywordflow}{do}\{                                       \(\backslash\)}
\DoxyCodeLine{                                      (\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_ad4cf225029dbefe8d3fe660c33b8bb6b}{Lock}} = HAL\_UNLOCKED;    \(\backslash\)}
\DoxyCodeLine{                                    \}\textcolor{keywordflow}{while} (0U)}
