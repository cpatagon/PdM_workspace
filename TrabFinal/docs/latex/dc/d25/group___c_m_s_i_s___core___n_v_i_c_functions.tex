...
Diagrama de colaboración para N\+V\+IC Functions\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{dc/d25/group___c_m_s_i_s___core___n_v_i_c_functions}
\end{center}
\end{figure}
...
Reads the priority grouping field from the N\+V\+IC Interrupt Controller. \begin{DoxyReturn}{Devuelve}
...
returns the F\+PU type \begin{DoxyReturn}{Devuelve}
