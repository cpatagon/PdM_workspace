...
Diagrama de colaboración para C\+M\+S\+IS Core Register Access Functions\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/dce/group___c_m_s_i_s___core___reg_acc_functions}
\end{center}
\end{figure}
...
Returns the content of the x\+P\+SR Register. \begin{DoxyReturn}{Devuelve}
...
Returns the content of the A\+P\+SR Register. \begin{DoxyReturn}{Devuelve}
...
Returns the content of the I\+P\+SR Register. \begin{DoxyReturn}{Devuelve}
...
Returns the current value of the Main Stack Pointer (M\+SP). \begin{DoxyReturn}{Devuelve}
M\+SP Register value 
\end{DoxyReturn}
...
Returns the current value of the Process Stack Pointer (P\+SP). \begin{DoxyReturn}{Devuelve}
P\+SP Register value 
\end{DoxyReturn}
