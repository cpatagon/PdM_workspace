...
Diagrama de colaboración para U\+A\+RT L\+IN Break Detection Length\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{df/de7/group___u_a_r_t___l_i_n___break___detection___length}
\end{center}
\end{figure}
