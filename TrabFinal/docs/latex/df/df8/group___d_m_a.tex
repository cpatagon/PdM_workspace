...
Diagrama de colaboración para D\+MA\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{df/df8/group___d_m_a}
\end{center}
\end{figure}
...
\DoxyCodeLine{ ((uint32\_t)((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_a2b30b6d22df80fbebd8ceefc6f162310}{Instance}}) > (uint32\_t)DMA1\_Stream7)? (DMA2-\/>LIFCR = (\_\_FLAG\_\_)) :\(\backslash\)}
...
\DoxyCodeLine{((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_a2b30b6d22df80fbebd8ceefc6f162310}{Instance}}-\/>CR \&= \string~(\_\_INTERRUPT\_\_)) : ((\_\_HANDLE\_\_)-\/>Instance-\/>FCR \&= \string~(\_\_INTERRUPT\_\_)))}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{(((\_\_INTERRUPT\_\_) != DMA\_IT\_FE)? \(\backslash\)}
\DoxyCodeLine{((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_a2b30b6d22df80fbebd8ceefc6f162310}{Instance}}-\/>CR |= (\_\_INTERRUPT\_\_)) : ((\_\_HANDLE\_\_)-\/>Instance-\/>FCR |= (\_\_INTERRUPT\_\_)))}
...
\DoxyCodeLine{ ((uint32\_t)((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_a2b30b6d22df80fbebd8ceefc6f162310}{Instance}}) > (uint32\_t)DMA1\_Stream7)? (DMA2-\/>LISR \& (\_\_FLAG\_\_)) :\(\backslash\)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{                                                        (((\_\_INTERRUPT\_\_) != DMA\_IT\_FE)? \(\backslash\)}
\DoxyCodeLine{                                                        ((\_\_HANDLE\_\_)-\/>\mbox{\hyperlink{struct_____u_a_r_t___handle_type_def_a2b30b6d22df80fbebd8ceefc6f162310}{Instance}}-\/>CR \& (\_\_INTERRUPT\_\_)) : \(\backslash\)}
